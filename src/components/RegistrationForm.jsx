          ...
          <Form.Field>
            <Grid columns='equal'>
               ...
               <Grid.Column>
                ...
                <Button id="regform" color='yellow' type='submit' onClick={ () => this.props.registerUser(this.state.username, this.state.displayName, this.state.password) }>submit</Button>
              </Grid.Column>
              <Grid.Column></Grid.Column>
            </Grid>
          </Form.Field>
